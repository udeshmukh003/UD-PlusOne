...
<p:forEach items="${data1}" var="w">
	...
	<p:url var="deletLink" value="/delet">
		<p:param name="pId" value="${w.pId }"></p:param>
	</p:url>
...
<td><a href="${deletLink }"><input type="button" value="Delete" /></a>
...
<br><br>
<a href="Register.jsp" data-inline="true" ><input type="button" value="Add New Member" style="height:60px" /></a>    
